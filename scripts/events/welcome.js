...
module.exports = {
    ...
    onStart: async ({ threadsData, event, message, usersData }) => {
        ...
        try {
            ...
            await message.reply({
                body: `🍓 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 🍓\n━━━━━━━━━━━━━━━━━━━━━━\nbienvenue à toi ${userName} dans le groupe ${threadName} il y a ${memberCount} membres Pour ne pas t'ennuyer 🤭\n tu à été ajouté par ${adderName}\n━━━━━━━━━━━━━━━━━━━😊`,
            ...
            const addedUser = event.logMessageData.addedParticipants[0];
            await message.send({
                body: `🍓 BIENVENUE ${addedUser.fullName}  À notre groupe familial !\n🌟 Nous sommes ravis de vous accueillir \n━━━━━━━━━━━━━━━━😊`
            });
        }
    }
};
